...
class BillingCycleForm extends Component {
    ...
    //Aqui estamos somando todos os nosso debitos e creditos juntos com os valores digitados nos inputs de forma dinamica
    calculateSummary(){
        const sum = (t, v ) => t + v
        return {
    ...
    render(){
        ...
        //ESSE METODO É UMA PROPRIEDADE DE HANDLESUBMIT
